...
#define CONFIG_mini2440_X35	'x'
#define CONFIG_mini2440_T35	't'
#define CONFIG_mini2440_N35	'n'

#define CONFIG_mini2440_W35	'w'

#define CONFIG_LCDTYPE           CONFIG_mini2440_W35
...
//#define CONFIG_BOOTARGS    	"console=ttySAC0 root=/dev/nfs nfsroot=192.168.1.210:/home/hanson/root_nfs/fs_mini ip=192.168.1.226:192.168.1.210:192.168.1.210:255.255.255.0:sbc2440.arm9.net:eth0:off"
#define CONFIG_BOOTARGS    	"console=ttySAC0 root=/dev/nfs nfsroot=192.168.1.72:/opt/rootfs ip=192.168.1.226:192.168.1.72:192.168.1.72:255.255.255.0:smdk2440a.embedclub.com:eth0:off"

#elif (BOOT_TYPE == BOOT_RAMDISK)
#define CONFIG_BOOTARGS    	"root=/dev/ram0 rw init=/linuxrc initrd=0x32800000,0x700000 console=ttySAC0,115200"
...
//#define CONFIG_BOOTCOMMAND	"nfs 0x30008000 192.168.0.72:/opt/uImage;bootm"
